...
\section{群作用と軌道分解}
	...
	\subsection{群$G$の剰余類分解}
		...
		\paragraph{部分群の群$G$への\redunderline{左からの乗法移動}による$g\in G$の$H$軌道}
			...
			\begin{example*}
				3次対称群$\mathcal{G}_3$に対して，部分群$H_1\qty(\simeq C_2), H_2\qty(\simeq C_3)$を次で定める．
				\begin{align*}
					H_1           & =\qty{e,\qty(1\ 2)},                                                       \\
					H_2           & =\qty{e, \qty(1\ 2\ 3), \qty(1\ 3\ 2)},                                    \\
					\mathcal{G}_3 & =\qty{e, \qty(1\ 2), \qty(1\ 3), \qty(2\ 3), \qty(1\ 2\ 3), \qty(1\ 3\ 2)}
				\end{align*}
				において，
				\begin{align*}
					eH_1          & =\qty{e, \qty(1\ 2)},                                \\
				...
				よって
				\[eH_1=\qty(1\ 2)H_1\]
				左剰余集合$\mathcal{G}_3/H_1=\qty{eH_1,\qty(1\ 3)H_1}$
				\begin{align*}
					...
					\mathcal{G}_3/H_1          & =\qty{e,\qty(1\ 2)}\sqcup\qty{\qty(1\ 3), \qty(1\ 2\ 3)}\sqcup\qty{\qty(2\ 3),\qty(1\ 3\ 2)} \\
					H_1\backslash\mathcal{G}_3 & =\qty{H_1e=H_1\qty(1\ 2),H_1\qty(1\ 3)=H_1\qty(1\ 3\ 2),H_1\qty(2\ 3)=H_1\qty(1\ 2\ 3)}      \\
				...
				\begin{align*}
					\mathcal{G}_3/H_2          & =\qty{eH_2,\qty(1\ 2)H_2},                                                                                  \\
					eH_2                       & =\qty{e,\qty(1\ 2\ 3),\qty(1\ 3\ 2)},                                                                       \\
					\qty(1\ 2)H_2              & =\qty{\qty(1\ 2),\qty(1\ 2)\qty(1\ 2\ 3)=\qty(2\ 3),\qty(1\ 2)\qty(1\ 3\ 2)=\qty(1\ 3)}                     \\
					H_2\backslash\mathcal{G}_3 & =\qty{H_2e,H_2\qty(1\ 2)}                                                                                   \\
					H_2e                       & =H_2,                                                                                                       \\
					H_2\qty(1\ 2)              & =\qty{e\qty(1\ 2),\qty(1\ 2\ 3)\qty(1\ 2)=\qty(1\ 3),\qty(1\ 3\ 2)\qty(1\ 2)=\qty(2\ 3)},                   \\
					\mathcal{G}_3/H_2          & =\qty{e,\qty(1\ 2\ 3),\qty(1\ 3\ 2)}\sqcup\qty{\qty(1\ 2),\qty(1\ 3),\qty(2\ 3)}=H_2\backslash\mathcal{G}_3
				\end{align*}
				{\color{red} ここで
